...
sudo apt-get -y install g++ libgtk-3-dev gtk-doc-tools gnutls-bin valac
sudo apt-get -y install libglib3.0-cil-dev libgnutls28-dev libgirepository1.0-dev
sudo apt-get -y install libxml2-utils gperf
